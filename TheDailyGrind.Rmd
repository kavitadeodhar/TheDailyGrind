...
sentiment_time <- function (pass_df)
{
Hist <- get_tweet_score(pass_df)
hist(Hist$negative - Hist$positive)
...
sentiment_time(Dunkin_clean_df)
sentiment_time(Starbucks_clean_df)
sentiment_time(McDonalds_clean_df)
sentiment_time(Panera_clean_df)
sentiment_time(Subway_clean_df)
